  ...
  return (
    <>
      <div className="tw-flex tw-flex-col md:tw-flex-row tw-gap-3 tw-h-auto md:tw-h-[50vh]">
        ...
        <div
          className="tw-w-full md:tw-w-[60%] tw-aspect-[4/3] md:tw-aspect-[4/3] tw-rounded-xl tw-overflow-hidden tw-cursor-pointer"
          onClick={() => handleMainClick(0)}
        >
          <Image
            src={`http://localhost:8000/images/${images[0]?.url}`}
            alt="main"
