        ...
        <div className="row g-0">
          ...
          <div className="col-12 col-md-4 mb-4">
            <div className="mt-4 mb-3">
              <img width="203" height="57" src="/img/image.png" alt="" />
            </div>
          ...
          {/* Cột 2 */}
          <div className={`col-12 col-md-4 mb-4 ${style.quick}`}>
          ...
          {/* Cột 3 */}
          <div className={`col-12 col-md-4 ${style.send}`}>
            <h2 className="fs-4 mb-3 text-white">ĐĂNG KÝ NHẬN TIN</h2>
            <p className="mb-4 text-white">
              Hãy nhập địa chỉ email của bạn vào ô dưới đây để nhận tin tức mới
              nhất.
            </p>
            <div className="d-flex">
              <input
                ...
                className={`${style.emailInput} border-0 rounded-start-4 flex-grow-1`}
              />
